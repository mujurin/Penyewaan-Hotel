                        ...
                        <div class="job-posts table-responsive">
                            <?php
                                ...
                                <?php
                                    ...
                                    {
                                        echo"<tr class='odd wow fadeInUp' data-wow-delay='1.2s'>";
                                        echo"<td class='tbl-logo'><a href='pict/{$row['foto']}'/>
                                            <img src='thumb/t_{$row['foto']}' width='100'/> </a></td>" ;
                                        echo"<td>".$row['tiperumah']."</td>" ;
                                        echo"<td>".$row['akomodasi']."</td>" ;
                                        echo"<td>".$row['terpesan']."</td>" ;
                                        echo"<td>"."<i class='icon-location'></i>".$row['lokasi']."</td>" ;
                                        echo"<td>"."Rp ".$row['harga']."</td>" ;
                                        echo"<td>"."<a href='order.php?idtuan=".$row['idtuan']."'>Order Now</a><br/>" ;
                                        echo"</tr>" ;
                                    }
                                ?>
                              </table>
